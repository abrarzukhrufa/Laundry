...
if($_POST){
    ...
    if(empty($nama_member)){
        ...
        include "koneksi.php";
        $insert=mysqli_query($conn,"insert into member (nama_member, alamat, jenis_kelamin, tlp, kota) value ('".$nama_member."','".$alamat."','".$jenis_kelamin."','".$tlp."','".$kota."')") or die(mysqli_error($conn));
        if($insert){
